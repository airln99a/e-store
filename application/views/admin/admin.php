   ...
   <div class="container-fluid">
     ...
     <div class="row">
       <div class="col-lg-4 col-xlg-3">
         <div class="card">
           <img class="card-img-top" src="<?= base_url('assets/admin/assets/images/background/profile-bg.jpg') ?>" alt="Card image cap">
           <div class="card-body little-profile text-center">
             <div class="pro-img"><img src="<?= base_url('assets/admin/assets/images/users/4.jpg') ?>" alt="user"></div>
             ...
             <div class="message-box contact-box">
               ...
               <div class="message-widget contact-widget">
                 <a href="#" class="d-flex align-items-center">
                   <div class="user-img mb-0"> <img src="<?= base_url('assets/admin/assets/images/users/1.jpg') ?>" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                   <div class="mail-contnet">
                     <h5 class="mb-0">Pavan kumar</h5> <span class="mail-desc">info@wrappixel.com</span>
                   </div>
                 </a>
                 <a href="#" class="d-flex align-items-center">
                   <div class="user-img mb-0"> <img src="<?= base_url('assets/admin/assets/images/users/2.jpg') ?>" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                   <div class="mail-contnet">
                 ...
                 <a href="#" class="d-flex align-items-center">
                   <div class="user-img mb-0"> <img src="<?= base_url('assets/admin/assets/images/users/4.jpg') ?>" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                   <div class="mail-contnet">
             ...
             <div class="tab-pane active" id="home" role="tabpanel">
               <div class="card-body">
                 <div class="profiletimeline border-start-0">
                   <div class="sl-item">
                     <div class="sl-left"> <img src="<?= base_url('assets/admin/assets/images/users/1.jpg') ?>" alt="user" class="img-circle"> </div>
                     <div class="sl-right">
                       <div><a href="#" class="link">John Doe</a> <span class="sl-date">5
                           minutes ago</span>
                         <p>assign a new task <a href="#"> Design weblayout</a></p>
                         <div class="row">
                           <div class="col-lg-3 col-md-6 mb-3"><img src="<?= base_url('assets/admin/assets/images/big/img1.jpg ') ?>" alt="user" class="img-responsive radius w-100"></div>
                           <div class="col-lg-3 col-md-6 mb-3"><img src="<?= base_url('assets/admin/assets/images/big/img2.jpg ') ?>" alt="user" class="img-responsive radius w-100"></div>
                           <div class="col-lg-3 col-md-6 mb-3"><img src="<?= base_url('assets/admin/assets/images/big/img3.jpg ') ?>" alt="user" class="img-responsive radius w-100"></div>
                           <div class="col-lg-3 col-md-6 mb-3"><img src="<?= base_url('assets/admin/assets/images/big/img4.jpg ') ?>" alt="user" class="img-responsive radius w-100"></div>
                         </div>
                   ...
                   <hr>
                   <div class="sl-item">
                     <div class="sl-left"> <img src="<?= base_url('assets/admin/assets/images/users/2.jpg ') ?>" alt="user" class="img-circle"> </div>
                     <div class="sl-right">
                       <div> <a href="#" class="link">John Doe</a> <span class="sl-date">5
                           minutes ago</span>
                         <div class="mt-3 row">
                           <div class="col-md-3 col-xs-12"><img src="<?= base_url('assets/admin/assets/images/big/img1.jpg') ?>" alt="user" class="img-responsive w-100 radius"></div>
                   ...
                   <hr>
                   <div class="sl-item">
                     <div class="sl-left"> <img src="<?= base_url('assets/admin/assets/images/users/3.jpg ') ?>" alt="user" class="img-circle"> </div>
                     <div class="sl-right">
                       <div><a href="#" class="link">John Doe</a> <span class="sl-date">5
                           minutes ago</span>
                   ...
                   <hr>
                   <div class="sl-item">
                     <div class="sl-left"> <img src="<?= base_url('assets/admin/assets/images/users/4.jpg') ?>" alt="user" class="img-circle"> </div>
                     <div class="sl-right">
                       <div><a href="#" class="link">John Doe</a> <span class="sl-date">5
                           minutes ago</span>
